...
export const projectsData = [
  {
    ...
    details:
      "Vanilla JS project with a focus on creating a visually appealing and interactive user interface.",
  ...
  },
  {
    ...
    label: "Respiration",
    details:
      "Respiration is a simple web application that allows users to track their breathing patterns and monitor their respiratory health.",
  ...
  },
  {
    ...
    label: "Miles",
    details: "A simple js application which build on webppack and react.",
    stacks: ["HTML5", "CSS3", "JavaScript", "Webpack", "NextJS"],
    gitLink: "https://github.com/cursorbot/cursorbot",
    image: heroImg,
  },
  {
    ...
    stacks: ["HTML5", "CSS3", "JavaScript", "Webpack", "VueeJS"],
    gitLink: "https://github.com/cursorbot/cursorbot",
    image: heroImg,
  },
  {
